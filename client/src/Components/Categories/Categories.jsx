    ...
    <div className='categories'>
      <div className="col">
        <div className="row">
            ...
            <button>
                <NavLink className="Navlink" to="products/1">Sale</NavLink>
            </button>
        </div>
        <div className="row">
      ...
      <div className="col">
        ...
        <img src="https://images.pexels.com/photos/1813947/pexels-photo-1813947.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
            <button>
                <NavLink className="Navlink" to="products/1">New Season</NavLink>
            </button>
        </div>
      </div>
      <div className="col col-l">
        <div className="row">
            ...
            <button>
                <NavLink className="Navlink" to="products/1">Men</NavLink>
            </button>
                </div>
            </div>
            <div className="col">
            ...
            <button>
                <NavLink className="Navlink" to="products/1">Accessories</NavLink>
            </button>
                </div>
            </div>
        </div>
        ...
        <img src="https://images.pexels.com/photos/1159670/pexels-photo-1159670.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
            <button>
                <NavLink className="Navlink" to="products/1">Shoes</NavLink>
            </button>
        </div>
      </div>
    </div>
